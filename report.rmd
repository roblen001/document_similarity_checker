...
for (i in 1:length(data$proposal_title)){
   ...
   cat('\n') 
   cat('\n')  
   cat("Author of Proposal:", data$author_of_proposal_title[i], "\n")
   cat('\n') 
   cat("Similar Proposal Title:", data$most_similar_proposal_title[i], "\n")
   cat('\n') 
   cat('\n')
   cat("Author of Similar Proposal:", data$common_words_weighted[i], "\n")
   cat('\n')
   ...
   cat("Amount of Common Words:", data$author_of_most_similar_proposal[i], "\n")
   cat('\n') 
   cat('\n')
